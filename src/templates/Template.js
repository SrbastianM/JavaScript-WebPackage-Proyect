    ...
    <div class="About">
      <div class="card">
        ...
        <div class="card_social">
          <a href="https://twitter.com/srbastian_m?t=MS52naw8-zFLA_3P9ThwDA&s=09">
            <img src="${twitter}" />
          </a>
          <a href="https://github.com/SrbastianM?tab=repositories">
            <img src="${gitHub}" />
          </a>
          <a href="https://instagram.com/srbastianm">
            <img src="${instagram}" />
          </a>
        </div>
      </div>
